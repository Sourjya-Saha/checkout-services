...
export default function SentinelOpsExactCloneHero() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0506] text-white selection:bg-red-600 selection:text-white font-epic antialiased overflow-x-hidden relative">
      {/* ========================================================================= */}
      {/* EXACT 1:1 CLONE HERO WITH GC EPIC PRO FONT & NOISE TEXTURE */}
      {/* ========================================================================= */}
      <section className="relative min-h-screen flex flex-col justify-between p-8 sm:p-14 overflow-hidden border-b border-red-950/40 select-none">
        ...
        {/* TOP RIGHT BACKGROUND BLURRED MOTION GLYPH: "SENTINEL" (GC EPIC PRO) */}
        <div className="absolute -top-6 -right-16 text-[14vw] sm:text-[16vw] font-epic font-extrabold uppercase text-red-600/70 tracking-tighter filter blur-[6px] sm:blur-[10px] pointer-events-none select-none z-0">
          SENTINEL
        </div>

        {/* BOTTOM BACKGROUND MASSIVE BLURRED GLYPH: "SENTINEL" (GC EPIC PRO) */}
        ...
        <div className="relative z-10 my-auto text-center py-16">
          ...
          <div className="relative inline-block">
            ...
            <span className="absolute top-2 left-6 sm:left-10 text-5xl sm:text-7xl md:text-8xl font-epic font-extrabold uppercase tracking-tighter text-red-600/50 filter blur-[4px] sm:blur-[7px] select-none pointer-events-none">
              SENTINEL OPS
            </span>

            {/* Motion Blur Trail Underlayer 2 */}
            <span className="absolute -top-1 left-3 sm:left-6 text-5xl sm:text-7xl md:text-8xl font-epic font-extrabold uppercase tracking-tighter text-red-500/70 filter blur-[2px] sm:blur-[3px] select-none pointer-events-none">
              SENTINEL OPS
            </span>
        ...
        <div className="relative z-10 flex justify-between items-end font-mono text-xs text-zinc-300">
          ...
          <div className="flex items-center gap-3">
            <a
              href="#checkout"
              className="px-4 py-2 rounded-full bg-red-600/80 hover:bg-red-500 text-white font-epic text-xs font-bold backdrop-blur-md border border-red-500/50 shadow-[0_0_20px_rgba(239,68,68,0.5)] transition-all"
            >
              Test Live Service &darr;
            </a>
            <Link
              href="/sentinelops"
              className="px-4 py-2 rounded-full bg-black/60 hover:bg-black text-white font-epic text-xs border border-zinc-700 backdrop-blur-md transition-all"
            >
              Swarm HUD &rarr;
            </Link>
          </div>
          ...
          <div className="text-right space-y-0.5">
            <p>Created for</p>
            <p className="text-white font-bold font-epic">TrueForge Hackathon</p>
          </div>
        </div>
      </section>
      ...
      {/* ========================================================================= */}
      <section id="checkout" className="px-6 sm:px-12 py-24 bg-[#080203] border-t border-red-950/60 font-epic">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-black/70 border border-zinc-900 space-y-6">
                ...
                <button
                  ...
                  disabled={loading}
                  className={`w-full py-4 rounded-xl font-epic text-xs font-extrabold uppercase tracking-widest transition-all ${
                    isGuest
