...
export default function CheckoutServiceGatewayPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0506] text-white font-epic antialiased selection:bg-red-600 selection:text-white px-6 sm:px-12 py-12">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="border-b border-red-950/80 pb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div className="space-y-1">
            ...
            >
              &larr; Back to SentinelOps Poster
            </Link>
            <span className="text-[10px] font-mono uppercase tracking-widest text-red-500 block mt-2">
